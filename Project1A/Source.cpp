...
int main(void)
{
	...
	// Purple background						////
	glClearColor(0.55f, 0.05f, 0.82f, 0.0f);	////
	...
	do {
		...
		// Draw the triangle !
		glDrawArrays(GL_TRIANGLES, 0, 4 * 3); // 4*3 indices starting at 0 -> 4 triangles
		...
		while (glfwGetKey(window, GLFW_KEY_C) == GLFW_PRESS) {
			...
			// Draw the triangle !
			glDrawArrays(GL_TRIANGLES, 0, 4 * 3); // 3 indices starting at 0 -> 4 triangles
