...
int main(void)
{
	...
	glm::mat4 Projection = glm::perspective(glm::radians(30.0f), 1.0f / 1.0f, 0.1f, 100.0f);
	// Camera matrix
	glm::mat4 View = glm::lookAt(
		glm::vec3(10, 10, 30), // Camera is at (10,10,30), in World Space
	...
	do {
		...
		if ((GetKeyState('Q') & 0x8000) && (!((GetKeyState(VK_SHIFT) & 0x8000) ^ (GetKeyState(VK_CAPITAL) & 1)))) {
			printf("DEBUG: q pressed\n");
			Model = glm::scale(ModelMatrix, glm::vec3(1.001f, 1.001f, 1.001f));
		}

		if ((GetKeyState('Z') & 0x8000) && (!((GetKeyState(VK_SHIFT) & 0x8000) ^ (GetKeyState(VK_CAPITAL) & 1)))) {
	...
	} // Check if Q (capital) was pressed or the window was closed	////
